...
- [Wyrok zaoczny — lekka integracja 07.07](project_wyrok_zaoczny.md) — nowy wzorzec: reuse istniejącego K1/scenariusza zamiast pełnej nowej kategorii; NIE zweryfikowane live (plik testowy zniknął z testy/)
- [Skille i pluginy w repo — 08.07](project_skills_setup.md) — frontend-design + find-skills commitowane w .agents/.claude/skills; pułapki: skills-lock nie czyści się sam, plugin uninstall wymaga --scope project

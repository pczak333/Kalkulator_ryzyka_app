...
- [Out-of-scope doc detection — 14.07](project_out_of_scope_detection.md) — użyj już wyciągniętych pól (sad_organ, powod) jako strukturalnego sygnału klasyfikacji, nie tylko keyword score; zweryfikowane live; formularz K1-K7 teraz ukryty za opt-in zamiast domyślnie aktywny

...
- [Out-of-scope doc detection — 14.07](project_out_of_scope_detection.md) — użyj już wyciągniętych pól (sad_organ, powod) jako strukturalnego sygnału klasyfikacji, nie tylko keyword score; 3 przypadki (KRS/PIT); keyword-count threshold zawodzi na długich dokumentach — potrzebny deterministyczny early-return

...
_PROMPT_TEMPLATE = (
    ...
    "null.\n\n"
    "Pisma komornicze (zawiadomienia o wszczęciu egzekucji, zajęcia, wykazy "
    "majątku) często NIE używają słów \"należność główna\"/\"odsetki\" wprost, "
    "tylko własnego słownictwa egzekucyjnego — stosuj te same dwie zasady "
    "(\"glowna\"/\"laczna\") analogicznie: gdy tabela/wykaz wylicza OSOBNO "
    "pozycje należność główna / odsetki / koszty egzekucyjne / koszty "
    "zastępstwa procesowego (lub podobny rozdział kwoty na składniki), "
    "zwróć w `kwota_zl` samą należność główną i `kwota_zl_rodzaj`=\"glowna\". "
    "Gdy dokument komorniczy podaje TYLKO jedną zbiorczą kwotę bez rozbicia "
    "na składniki (np. \"kwota zadłużenia\", \"kwota do zapłaty\", \"suma "
    "egzekwowana\", \"wysokość egzekwowanego świadczenia\"), zwróć tę kwotę "
    "w `kwota_zl` i `kwota_zl_rodzaj`=\"laczna\" — tak jak dla każdego "
    "innego pisma bez rozbicia. Nie zostawiaj `kwota_zl_rodzaj`=null tylko "
    "dlatego, że dokument jest pismem komorniczym, a nie pozwem/nakazem — "
    "dotyczy to KAŻDEGO typu pisma zawierającego kwotę.\n\n"
